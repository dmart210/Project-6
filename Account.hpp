...
*/
    bool updatePost(Post* post, std::string new_title, std::string new_body); // update this 

    Post* getMinLikes() const;//O(1)
    Post* getMaxLikes() const;//O(1)
    std::vector<Post*> increasingPriorityOldestToNewest(); //O(n)
